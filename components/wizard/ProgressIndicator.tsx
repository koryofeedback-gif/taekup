...
const STEP_KEYS = [
  'wizard.progress.clubInfo',
  'wizard.progress.belts',
  'wizard.progress.skills',
  'wizard.progress.rules',
  'wizard.progress.people',
  'wizard.progress.branding',
];

export const ProgressIndicator: React.FC<ProgressIndicatorProps> = ({ totalSteps, currentStep, language, onStepClick }) => {
  ...
  return (
    <div className="flex items-center justify-between">
      {Array.from({ length: totalSteps }, (_, i) => {
        ...
        const stepLabel = STEP_KEYS[i] ? t(STEP_KEYS[i]) : `Step ${step}`;
