...
app.use((req, res, next) => {
  ...
  if (req.path.startsWith('/api/')) {
    ...
    res.setHeader('Content-Security-Policy', [
      ...
      "img-src 'self' data: blob: https://flagcdn.com https://*.mytaek.com https://*.idrivee2.com",
      "font-src 'self' data:",
      "connect-src 'self' https://*.mytaek.com https://api.stripe.com https://api.openai.com https://generativelanguage.googleapis.com https://*.idrivee2.com ws: wss:",
      "media-src 'self' blob: https://*.idrivee2.com",
