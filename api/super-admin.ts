    ...
    const templates: Record<string, EmailTemplateConfig> = {
      ...
      'day_7_mid_trial': {
        ...
        getDynamicData: () => ({
          ...
          name: club.owner_name || 'there',
          clubName: club.name,
          body: `You're halfway through your 14-day trial with <strong>${club.name}</strong>! We hope you're enjoying the platform.<br><br>Have you tried these features yet?<br>• Legacy Cards™ for your students<br>• Global Shogun Rank™ leaderboards<br>• AI-powered TaekBot assistant<br><br>Let us know if you have any questions!`,
      ...
      'trial_expired': {
        ...
        getDynamicData: () => ({
          ...
          name: club.owner_name || 'there',
          clubName: club.name,
          body: `Your 14-day free trial for <strong>${club.name}</strong> has expired. But don't worry - your data is safe!<br><br>Reactivate your account now to continue using all the features that help you run your martial arts club more efficiently.`,
      ...
      'payment_failed': {
        ...
        getDynamicData: () => ({
          ...
          name: club.owner_name || 'there',
          clubName: club.name,
          body: `We were unable to process your payment for <strong>${club.name}</strong>. Please update your payment method to avoid service interruption.<br><br>Your students depend on TaekUp for their HonorXP™ tracking and Legacy Cards™ - let's keep them engaged!`,
      ...
      'feature_announcement': {
        ...
        getDynamicData: () => ({
          ...
          name: club.owner_name || 'there',
          clubName: club.name,
          body: `We've just released exciting new features for <strong>${club.name}</strong>!<br><br>Check out what's new:<br>• Enhanced ChronosBelt™ Predictor for belt promotions<br>• Improved DojoMint™ Protocol for payments<br>• New challenge categories in Dojang Rivals<br><br>Log in to explore these updates!`,
