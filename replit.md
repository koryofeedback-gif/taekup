...
- **Parent Portal**: Tracks student journey, provides AI insights, practice curriculum, booking, gamification, daily habits, and digital student cards. Feedback Center has two tabs: "Sessions" (full grading history with skill breakdowns, color dots, HonorXP, coach notes, stripe progress) and "Videos" (video submissions). Grading data stored in `grading_sessions` table.
